...
# 第六种:
# 将 {'username': 'admin', 'age': 18, 'gender': True}
# 转化为 [{key: 'username', value: 'admin', param_type: 'string'}, {key: 'age', value: 18, param_type: 'int'}]
...
def handle_data6(data):
    ...
    处理第六种类型的数据转化
    将 {'username': 'admin', 'age': 18, 'gender': True}
    [{key: 'username', value: 'admin', param_type: 'string'}, {key: 'age', value: 18, param_type: 'int'}]
    :param data: 待转换的参数列表
    :return:
    """
    result_list = []
